...
def main():
    ap = argparse.ArgumentParser(
        description="Check ORCA freq_b97_3c jobs under downselected/molXXXX/freq_b97_3c/"
    )
    ap.add_argument(
        "--root",
        required=True,
    ...
    for mol_dir in sorted(root.iterdir()):
        ...
        if not run_dir.is_dir():
            missing_out.append((mol_dir.name, "freq directory missing"))
            continue
    ...
    print("\n===== ORCA freq_b97_3c CHECK SUMMARY =====\n")
